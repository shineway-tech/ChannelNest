export function icon(name: string) {
  const icons: Record<string, string> = {
    ...
    crown: '<svg viewBox="0 0 24 24"><path d="m3 6 4.5 5L12 4l4.5 7L21 6l-2 12H5L3 6Z"/><path d="M5 18h14"/></svg>',
    ...
    idCard: '<svg viewBox="0 0 24 24"><rect x="3" y="5" width="18" height="14" rx="3"/><circle cx="8.5" cy="11" r="2"/><path d="M6 16a3 3 0 0 1 5 0M14 10h4M14 14h3"/></svg>',
    ...
    pause: '<svg viewBox="0 0 24 24"><path d="M8 5h3v14H8ZM13 5h3v14h-3Z"/></svg>',
    ...
    users: '<svg viewBox="0 0 24 24"><path d="M16 20a6 6 0 0 0-12 0"/><circle cx="10" cy="8" r="4"/><path d="M22 20a5 5 0 0 0-5-5"/><path d="M17 4a4 4 0 0 1 0 8"/></svg>',
    wallet: '<svg viewBox="0 0 24 24"><path d="M4 6h15a2 2 0 0 1 2 2v11H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h12"/><path d="M16 11h5v5h-5a2 2 0 0 1 0-5Z"/></svg>',
